const SECRET_VALUE_PATTERNS = [
  /(OPENAI_API_KEY|GITHUB_TOKEN|GH_TOKEN|JIRA_TOKEN|JIRA_API_TOKEN|PLANE_TOKEN|SSH_(?:KEY|PRIVATE_KEY)|API_TOKEN|ACCESS_TOKEN|DATABASE_URL|SECRET|PASSWORD)=([^\s'";)]+)/gi,
